        ...
        <>
            ...
            {sectionOpen ? (
                <>
                    ...
                    <div className="Spacer-1X" />
                    <p>
                        Collaborated with a leading cloud logistics vendor to
                        create and implement product marketing and channel
                        strategy during the company’s pivot to a new market
                        segment.
                    </p>
                    ...
                    <p>
                        Led B2B and developer marketing strategy for the world’s
                        largest registry of open-source software.
                    </p>
                    ...
                    <p>
                        ...
                        positioning, and content marketing for technology and
                        consumer brands.
                    </p>
                </>
            ) : (
